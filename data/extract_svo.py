...
def _get_subs_from_conjunctions(subs):
    ...
    for sub in subs:
        ...
        if contains_conj(rightDeps, rightDepTags):
            more_subs.extend(
                [tok for tok in rights if tok.dep_ in SUBJECTS or tok.pos_ == "NOUN" or tok.dep_ == "conj"])
            if len(more_subs) > 0:
...
if __name__ == '__main__':
    # test_cases = [
    #     [0, 4642,
    #      "Scientists are still investigating this branch of the outbreak , trying to establish if the virus - perhaps present in human faeces - was spread by vermin or by leaking sewage along a vertical shaft in the building ."],
    #     [1, 9406,
    ...
    #     [4, 74944,
    #      "China , Singapore , Malaysia , Indonesia and Vietnam continue to execute people who use drugs in high numbers ."],
    #     [5, 133,
    ...
    #     [7, 35594,
    #      "Last month , President Dilma Rousseff mobilized 220,000 troops to give out leaflets and help householders eliminate breeding grounds of the mosquito that spreads Zika ."],
    #     [8, 2198,
    #      "As of March 25 , a cluster of 13 persons with suspected / probable SARS are known to have stayed at hotel M ( Figure 1 ) ."],
    #     [9, 5148,
    #      "\" When they [ the prosecutors ] decide who should bear the responsibility [ for the outbreak ] , we 'll know who to blame as well ."]
    # ]

    test_cases = [[0 ,0, "a better one might be, people do and people die and still other people search their souls and struggle for redemption."]]
