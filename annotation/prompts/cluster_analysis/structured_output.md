You will receive a JSON object containing a sentence that summarizes the central theme of a narrative cluster. Your task is to ensure this JSON is properly formatted according to the required schema.
